package com.oept.uic.web.filter;
...
public class LoginFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if(path.indexOf("/login.") > -1 || path.indexOf("/logout.") > -1 || path.indexOf("/refresh") > -1 ||
        		"/OEPT_UIC/".equals(path)) {
        ...
        if (userName == null || "".equals(userName)) {
            // do redirect
        	servletResponse.sendRedirect("/OEPT_UIC/");
