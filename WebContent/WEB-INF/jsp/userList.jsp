					...
					<div class="modal-content">
						...
						<div class="row">
							<div class="col-md-6">
								...
								<input type="text" class="form-control" placeholder="请输入姓氏…" id="lastname">
								<label class="control-label">名字：</label>
								<input type="text" class="form-control" placeholder="请输入名字…" id="firstname">
							</div>
							<div class="col-md-6">
								<label>看板权限：</label>
					...
					<div class="portlet box grey-cascade">
						...
						<div class="portlet-body">
	                		...
	                		<tr class="odd gradeX">
	                    		...
	                    		<td id="${user._uic_user_id}"><a href="<%=path%>/user/details.do?userId=${user._uic_user_id}">${user._uic_username}</a></td>
	                    		<td>
	                    			${user._uic_lastname}                		
								</td>
	                    		<td>
	                    		...
	                    		<c:forEach var="permission" items="${user._permission}">
	                    			${permission._uic_permission_name}, 
	                    		</c:forEach>
	                    		</td>
	                    		<td>
