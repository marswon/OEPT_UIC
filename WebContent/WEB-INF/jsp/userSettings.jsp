										...
										<form class="form-horizontal">								
											...
											<div class="alert alert-success display-hide"
												...
												<div class="form-group">
													...
													<div class="col-md-4">															
														<input type="text" class="form-control input-circle" placeholder="姓氏" value="${user._uic_lastname}" id="lastname">
													</div>
												</div>
												<div class="form-group">
													<label class="col-md-3 control-label">名字</label>
													<div class="col-md-4">
														<input type="text" class="form-control input-circle" placeholder="名字" value="${user._uic_firstname}" id="firstname">
													</div>
												</div>								
											</div>
